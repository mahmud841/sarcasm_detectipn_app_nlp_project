...
st.sidebar.header("About the Sarcasm Detection Application ")
st.sidebar.info("""
**Sarcasm Detection Application** allows you to detect sarcasm in text through three methods:
...
st.sidebar.markdown("---")
st.sidebar.markdown("**Created by Mahmud Suruj**")
